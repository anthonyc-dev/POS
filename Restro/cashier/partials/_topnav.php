                    ...
                    <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                        ...
                        <div class="media align-items-center">
                            <span class="avatar avatar-sm rounded-circle">
                                <img alt="Image placeholder"  <img src="<?php echo isset($staff->staff_image) ? $staff->staff_image : '../admin/assets/img/theme/man.png'; ?>"
                                                class="rounded-circle"
                                                style="marginborder-radius: 50%; width: 40px; height: 40px; object-fit: cover;">
                            </span>
