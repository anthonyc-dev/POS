...
<style>
    #sidenav-main {
      background: linear-gradient(to top, #1e3a5f, #0d253f);
...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main" style="width: 220px;">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="orders.php">
            <i class="ni ni-cart text-primary"></i> Place Order
          </a>
        </li>
        <li class="nav-item">
