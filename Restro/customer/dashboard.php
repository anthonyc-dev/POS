...
$customer_id = $_SESSION['customer_id'];  // Use the appropriate session variable for customer ID
$sql = "SELECT customer_name FROM rpos_customers WHERE customer_id = ?";
...
<body>
          ...
          <div class="col-xl-4 col-lg-6">
            <a href="orders.php">
              <div class="card card-stats mb-4 mb-xl-0"
                style="background: linear-gradient(to bottom, #6a11cb, #2575fc); border-radius: 15px; box-shadow: 0 10px 15px rgba(0, 0, 0, 0.1); transition: transform 0.3s ease-in-out;">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-white mb-0">Available Items</h5>
            ...
            <a href="orders_reports.php">
              <div class="card card-stats mb-4 mb-xl-0"
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-white mb-0">Total Orders</h5>
            ...
            <a href="payments_reports.php">
              <div class="card card-stats mb-4 mb-xl-0"
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-white mb-0">Total Money Spend</h5>
                ...
                <tbody>
                  ...
                  while ($order = $res->fetch_object()) {
                    ...
                    <tr>
                      ...
                      <td>
                        <?php echo $order->order_status == '' ? "<span class='badge badge-danger'>Not Paid</span>" : "<span class='badge badge-success'>$order->order_status</span>"; ?>
                      </td>
  ...
  <?php if (isset($customer_name)) { ?>
    ...
    <script>
      Swal.fire({
        title: 'Welcome, <?php echo $customer_name; ?>!',
