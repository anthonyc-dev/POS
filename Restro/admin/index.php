...
if (isset($_POST['login'])) {
    ...
    $admin_password = $_POST['admin_password']; // No hashing, use the plain password directly
...
<style>
    body {
        ...
        background: linear-gradient(135deg, #e63946, #f1faee, #a8dadc); /* Darker reddish sunset gradient */
        display: flex;
        ...
        <div class="card bg-white shadow border-0">
            <div class="card-body">
                ...
                <form method="post" role="form">
                    <h3 class="text-center mb-4" style="color: #5c6bc0;">Admin Login</h3>
